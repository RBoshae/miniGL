...
cout << "Out of mglReadPixels"; // Debugging
               ...
               MGLfloat z)
{
  ...
  rotation_matrix(3,0) = (x*z)*(1-cos(angle)) + y*sin(angle);
  rotation_matrix(3,1) = (y*z)*(1-cos(angle)) + x*sin(angle);
  rotation_matrix(3,2) = (z*z)*(1-cos(angle)) + cos(angle);
